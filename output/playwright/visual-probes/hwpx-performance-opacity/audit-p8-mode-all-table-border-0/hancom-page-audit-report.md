...
## p8-mode-all-table-border-0.hwpx
...
| ---: | --- | --- | ---: | ---: | ---: | --- | --- |
| 1 | pass | close | 17.750 | 16.973 | 36.108 | pass: raw pixel diff is inside the close band. | `output/playwright/visual-probes/hwpx-performance-opacity/audit-p8-mode-all-table-border-0/p8-mode-all-table-border-0/compare/page-001-compare.png` |
