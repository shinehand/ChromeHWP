...
## incheon-2a-p16-border-1.hwpx

- source: `/Users/shinehandmac/Github/ChromeHWP/output/playwright/inputs/incheon-2a.hwpx`
- pages: 1
- verdicts: {'layout-review': 1}
- severity: {'advisory': 1}
- advisory pages: p1 layout-review raw=34.948 blur=30.386 layout=25.419

| page | severity | verdict | raw diff | blur diff | layout diff | note | compare |
| ---: | --- | --- | ---: | ---: | ---: | --- | --- |
| 1 | advisory | layout-review | 34.948 | 30.386 | 25.419 | advisory: raw pixel diff is above the review band, but blur/layout metrics are within the relaxed layout-review band; this is not a clean pass. | `output/playwright/visual-probes/hwpx-performance-opacity/audit-border-1/incheon-p16-border-1/compare/page-001-compare.png` |
