...
## p18-mode-all-nested-border-0.hwpx
...
| ---: | --- | --- | ---: | ---: | ---: | --- | --- |
| 1 | pass | close | 16.919 | 16.048 | 23.654 | pass: raw pixel diff is inside the close band. | `output/playwright/visual-probes/hwpx-performance-opacity/audit-p18-mode-all-nested-border-0/p18-mode-all-nested-border-0/compare/page-001-compare.png` |
