...
## p18-mode-all-table-border-0.hwpx
...
| ---: | --- | --- | ---: | ---: | ---: | --- | --- |
| 1 | pass | close | 16.497 | 15.812 | 24.356 | pass: raw pixel diff is inside the close band. | `output/playwright/visual-probes/hwpx-performance-opacity/audit-p18-mode-all-table-border-0/p18-mode-all-table-border-0/compare/page-001-compare.png` |
