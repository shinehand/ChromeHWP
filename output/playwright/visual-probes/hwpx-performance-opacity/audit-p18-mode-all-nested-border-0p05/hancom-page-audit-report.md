...
## p18-mode-all-nested-border-0p05.hwpx
...
| ---: | --- | --- | ---: | ---: | ---: | --- | --- |
| 1 | pass | close | 16.969 | 16.043 | 23.648 | pass: raw pixel diff is inside the close band. | `output/playwright/visual-probes/hwpx-performance-opacity/audit-p18-mode-all-nested-border-0p05/p18-mode-all-nested-border-0p05/compare/page-001-compare.png` |
