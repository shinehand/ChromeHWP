...
## incheon-2a-p16-op-0p75.hwpx

- source: `/Users/shinehandmac/Github/ChromeHWP/output/playwright/inputs/incheon-2a.hwpx`
- pages: 1
- verdicts: {'layout-review': 1}
- severity: {'advisory': 1}
- advisory pages: p1 layout-review raw=35.140 blur=30.407 layout=23.149

| page | severity | verdict | raw diff | blur diff | layout diff | note | compare |
| ---: | --- | --- | ---: | ---: | ---: | --- | --- |
| 1 | advisory | layout-review | 35.140 | 30.407 | 23.149 | advisory: raw pixel diff is above the review band, but blur/layout metrics are within the relaxed layout-review band; this is not a clean pass. | `output/playwright/visual-probes/hwpx-performance-opacity/audit-0p75/incheon-p16-op-0p75/compare/page-001-compare.png` |
